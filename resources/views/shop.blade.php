              ...
              <ul class="list list-inline mb-0">
                ...
                <li class="list-item">
                  <span class="menu-link py-1">
                    <input type="checkbox" class="chk-category" name="categories" value="{{$category->id}}" @if(in_array($category->id,explode(',',$f_categories))) checked="checked" @endif />
                    {{$category->name}}
                  </span>
        ...
        <div class="accordion-item mb-4">
          ...
          <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
            ...
            <div class="price-range__info d-flex align-items-center mt-2">
              <div class="me-auto">
                <span class="text-secondary">Min Precio: </span>
                <span class="price-range__min">s/.1</span>
              </div>
              <div>
                <span class="text-secondary">Max Precio: </span>
                <span class="price-range__max">s/.500</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="swiper-slide">
            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
              <div class="slide-split_text position-relative d-flex align-items-center"
                style="background-color: #a9e9a4;">
                <div class="slideshow-text container p-3 p-xl-5">
                  <h2
                    class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                    ¡Ofertas en <br /><strong>PRODUCTOS PARA MASCOTAS!</strong></h2>
                  <p class="mb-0 animate animate_fade animate_btt animate_delay-5"> Encuentra los mejores productos para tu mascota. Desde alimentos hasta accesorios, tenemos todo lo que tu
                    amigo peludo necesita para estar feliz y saludable.
                </div>
              </div>
            ...
            <div class="pc__img-wrapper">
              ...
              <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                ...
                <button type="submit"
                  ...
                  data-aside="cartDrawer" title="Add To Cart">Agregar a Carrito</button>
              </form>
              @endif
            </div>
            ...
            <div class="pc__info position-relative">
              ...
              <div class="product-card__price d-flex">
                <span class="money price">
                  ...
                  <s>s/.{{$product->regular_price}}</s> s/.{{$product->sale_price}}
                  @else
